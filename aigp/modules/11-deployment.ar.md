...
| **التطبيق والتعلّم** | الرصد، ومسار للإبلاغ عن الأخطاء دون لوم، وعواقب متناسبة للمخالفات المتعمدة، وعملية للاستثناءات، ومراجعة دورية لما يحتاجه الناس فعلًا | استبيان الذكاء الاصطناعي الظلّي (shadow AI) يغذّي خارطة طريق الأدوات المعتمدة |
