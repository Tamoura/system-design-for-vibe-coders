...
4. **التعليمات والبيانات تتشارك قناة واحدة.** قد يحتوي مستند يُمرَّر إلى النموذج على نص يعامله النموذج كتعليمات، ويُعرف ذلك بـ **حقن الطلبات (prompt injection)**. وهذه مشكلة أمنية جديدة لا توجد في البرمجيات العادية بالشكل نفسه.
...
| 3 | هل يستخدم نموذجًا للأغراض العامة أو نموذجًا أساسيًا (مثل نموذج لغوي كبير عبر API)؟ | سجّل مقدّم النموذج وإصداره؛ ونبّه إلى مخاطر الذكاء الاصطناعي التوليدي (التلفيق، وحقن الطلبات، وتسرّب البيانات) |
...
| **سوء الاستخدام والهجوم (Misuse and attack)** | الإساءة المتعمدة، وحقن الطلبات، وتسميم البيانات | محتالون يتحسسون حدود نموذج الاحتيال |
...
| أمن المعلومات | حقن الطلبات، والتلاعب بالنموذج، وتسهيل التصيّد |
...
- **فخ: معاملة مخاطر الذكاء الاصطناعي التوليدي كمخاطر النماذج التنبؤية.** التلفيق والمحتوى الضار والملكية الفكرية وحقن الطلبات تحتاج إلى ضوابط خاصة بالذكاء الاصطناعي التوليدي.
...
| أمن المعلومات | التحكم في الوصول، ونمذجة التهديدات، والاختبار | حقن الطلبات، وتسميم البيانات، واستخراج النموذج، وتصفية المخرجات |
