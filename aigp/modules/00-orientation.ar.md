...
*المستوى: 🟢 مبتدئ* · *المتطلبات: لا يوجد* · *مجال المعرفة (BoK): Orientation (all domains)*
...
**الحوكمة بوصفها نظام إدارة (management system).** تتعامل البرامج الناضجة مع حوكمة الذكاء الاصطناعي مثل أي نظام إدارة آخر: خطّط (ضع السياسة والأهداف ومعايير المخاطر)، ونفّذ (شغّل العمليات)، وتحقّق (ارصد ودقّق وقِس)، وحسّن (طوّر). وقد بُني ISO/IEC 42001 على دورة خطّط-نفّذ-تحقّق-حسّن (Plan-Do-Check-Act) هذه تحديدًا، ويمكن اعتماده بشهادة من جهة معتمدة. وقيمة النظر إليها كنظام إدارة أنها تفرض التكرار: فالمؤسسة لا توافق على الذكاء الاصطناعي فحسب، بل تواصل التحقق مما إذا كانت موافقاتها صحيحة.
...
| **ISO/IEC 42001** | معيار لنظام إدارة الذكاء الاصطناعي (AIMS) قابل للاعتماد بشهادة، ومبني على خطّط-نفّذ-تحقّق-حسّن، مع ضوابط الملحق A | عبارات "نظام إدارة" و"شهادة" و"التحسين المستمر" تشير إلى هنا |
...
*المستوى: 🟢 مبتدئ* · *المتطلبات: 0.1* · *مجال المعرفة (BoK): Orientation (all domains)*
...
*المستوى: 🟢 مبتدئ* · *المتطلبات: 0.1* · *مجال المعرفة (BoK): Orientation · I.A, I.C*
...
- **انظر إلى الشبكة.** تكشف سجلات الوكيل الشبكي (web-proxy logs) حركة المرور إلى خدمات الذكاء الاصطناعي التوليدي العامة (الذكاء الاصطناعي الظل (shadow AI)).
...
**الأدوار ليست واضحة دائمًا.** بنك نجم *يبني* نموذج الائتمان و*يستخدمه*، لذا يحمل واجبات من نوع مقدّم النظام وواجبات من نوع المُشغِّل معًا. وفي مساعد مذكرات الائتمان، يُشغّل بنك نجم نموذج ذكاء اصطناعي توليدي لطرف ثالث لكنه يبني تطبيقه الخاص حوله. وبموجب EU AI Act، قد يؤدي تعديل نظام أو وضع اسمك عليه إلى تغيير دورك. ويسجّل السجل دور بنك نجم لكل نظام لأن الأدوار تحدد الواجبات (الوحدة 6).

**الذكاء الاصطناعي المدمج والذكاء الاصطناعي الظل.** هناك فئتان يسهل إغفالهما. **الذكاء الاصطناعي المدمج (Embedded AI)** هو الذكاء الاصطناعي داخل منتجات اشتُريت لأسباب أخرى: مساعد الكتابة في منصة بريد إلكتروني، وتقييم العملاء المحتملين في نظام إدارة علاقات العملاء (CRM)، ومطابقة المرشحين في حزمة موارد بشرية. و**الذكاء الاصطناعي الظل (Shadow AI)** هو الذكاء الاصطناعي الذي يستخدمه الموظفون دون موافقة، مثل الصف 6. وكلاهما يحتاج إلى قيود في السجل. وبالنسبة إلى الذكاء الاصطناعي الظل، قدّم بديلًا معتمدًا بشروط تعاقدية سليمة، فالحظر دون بديل يدفع الاستخدام إلى الخفاء.
...
**D.** يحتاج الذكاء الاصطناعي الظل إلى الرؤية والملكية وقواعد واضحة وبديل آمن. يتجاهل A التعرّض لمخاطر السرية وحماية البيانات، أما B وC فغير متناسبين ويميلان إلى دفع الاستخدام إلى الخفاء بدلًا من حوكمته. (انظر 🔴 الذكاء الاصطناعي المدمج والذكاء الاصطناعي الظل، ومحضر اللجنة.)
