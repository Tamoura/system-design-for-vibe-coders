...
أصبحت مسائل المادة 22 والتفسير تستند الآن إلى نموذج يستطيع نجم تفسيره، وانحصرت مخاطر الذكاء الاصطناعي التوليدي (التلفيق (confabulation)، والتسرب (leakage)، وحقن التعليمات (prompt injection)) في النص السردي، حيث يمكن للإحالات والمراجعة البشرية أن تكشفها.
...
| الأمن | الشهادات، ونتائج اختبارات الاختراق (pen-test)، والدفاعات ضد حقن التعليمات | معايير الأمن؛ الإخطار بالاختراقات والحوادث خلال ساعات متفق عليها؛ التعاون في التحقيقات |
...
| استخدام البيانات المرسلة إلى المورّد أو الاحتفاظ بها | جميع العملاء | منخفض / عالٍ | الشروط التعاقدية؛ تعليمات مقلَّصة البيانات؛ استخدام الأسماء المستعارة (pseudonymisation) حيثما أمكن | منخفض |
