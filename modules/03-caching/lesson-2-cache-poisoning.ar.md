...
ثم **غيّرت ترقيةُ إطارٍ بصمت أيَّ ترويسات يراها الوسيط** — فنُزعت إشارةُ كشف flight قبل أن يعمل الوسيط أصلًا. لم ينكسر الإصلاح بصخب؛ بل صار خامدًا. وعادت الثغرة بهدوء، تنتظر أول طلبٍ منحوس تالٍ.
...
لم ينكسر إصلاح الوسيط؛ صار خامدًا. لم ينبّه شيء. فكلما شحنت دفاعًا، اسأل: *إن كفّ هذا عن العمل، ما الذي يخبرني؟* إن كان الجواب «تتكرر الحادثة» فأضف اختبارًا أو مسبارًا يفشل بصخب بدلًا من ذلك — هنا: فحصٌ اصطناعي يجلب صفحةً بترويسات flight ويؤكد أن الاستجابة غير قابلة للتخزين.
...
2. **اجعله قابلًا للتخزين، ثم سمّمه.**
   ...
   انظر إليه. ولاحظ كيف أن *لا شيء في سجلات التطبيق* يُظهر خطأً — فالسمُّ يسكن طبقة الكاش وحدها.
3. **ثبّت الحاجز.**
...
- جيمس كتل (PortSwigger): **«تسميم كاش الويب عمليًا»** (2018) وتوابعه — المعالجة الأمنية الهجومية المرجعية؛ مهاجمُك قرأها.
