...
> 🔧 **إضافة المهمة إلى الطابور هي نفسها مفصل كتابة مزدوجة.** انظر مجددًا إلى خطوة «احفظ السجل، ثم أضف إلى الطابور» البريئة: إنها تكتب إلى *نظامين*، هما قاعدة البيانات والطابور. فإذا نجح إيداع قاعدة البيانات ثم فشلت الإضافة إلى الطابور (ومضة في الطابور، أو تعطّل العملية بينهما)، تكون قد فقدت المهمة دون أي خطأ يراه المستخدم — وهذا بالضبط فخّ التباعد الصامت من الدرس 2.6. حلّان متينان: **صندوق الصادر المعامَلاتي (Transactional Outbox)** — اكتب المهمة في صف `outbox` *ضمن معاملة قاعدة البيانات نفسها* التي تحفظ السجل، ثم يقرأ ناقلٌ منفصل ذلك الجدول ويدفعه إلى الطابور (والكتابة ذرّية لأنها معاملة واحدة)؛ أو **مسح المصالحة (Reconciliation)** — امسح دوريًا السجلات التي في حالة «معلّقة» بلا مهمة مكتملة مقابلة وأعد إضافتها إلى الطابور. وفي الحالتين المبدأ نفسه المتكرر في هذه الدورة: *اجعل الكتابتين واحدة، أو ابنِ شيئًا يلاحظ حين تتباعدان.*
