...
**الأساسي** ميزانيةً لكل عنوان IP ولكل مستلِم (فالمهاجم من عنوان واحد، أو الذي يقصف
عنوانًا واحدًا، يُوقَف دون المساس بأحد آخر)، وأبقِ الميزانية العامة مجرد شبكة أمان
أخيرة، بسقفٍ مرتفع بما يكفي كي لا تبلغه الحركة الطبيعية أبدًا. ونبّه حين تُستنفد
...
الجميع أم يمرّر الطلبات دون عدّ؟ بالنسبة لمحدِّد *إساءة عام*: **افشل مفتوحًا**؛ فمحدِّدٌ
يفشل مغلقًا يحوّل ومضة Redis إلى عطل كامل. المحدِّد حاجزُ أمان، لا جدارٌ حامل؛ فليتدهور
إلى «بلا حدّ لحظةً» بدل «معطّل».

**لكن هناك استثناء مهم: محدِّدات المصادقة تفشل *مغلقة*.** فالمحدِّد الذي يقيّد محاولات
الدخول، وتخمينات إعادة تعيين كلمة المرور، ومحاولات الرمز لمرة واحدة، هو دفاع ضد القوة
الغاشمة (Brute Force)، لا ميزة راحة. فإن فشل مفتوحًا، صارت ومضة Redis نافذةً مفتوحة
لحشو بيانات الاعتماد، في اللحظة التي تكون فيها أقل قدرة على الملاحظة. لذلك، عند أخطاء
...
السقف بالكامل أبدًا. القاعدة: *محدِّدات الإساءة العامة تفشل مفتوحة؛ وأي شيء يحرس سرًّا
يفشل مغلقًا.*
