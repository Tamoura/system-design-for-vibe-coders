...
لقد عشتَ نسخة الويب من هذا بنفسك: تبويب متصفح تركته مفتوحًا طوال الليل، ما زال يشغّل
JavaScript الأسبوع الماضي، فيبدأ فجأةً برمي الأخطاء لأن الواجهة البرمجية التي يناديها أُعيد
نشرها قبل ساعات. ذلك التبويب **متخلّف (Straggler)**: نسخة أطلقتَها ولم تعد تصل إليها، وما زالت
ترسل الطلبات إلى خادم خلفي يفترض أن الجميع أعاد التحميل. على الويب يشفى المتخلّف لحظة يعيد
المستخدم التحميل. أما على الموبايل فلا يعيد التحميل من تلقاء نفسه أبدًا: **كودٌ قديم لا تصل
...
هذا هو فخّ الإصدار المتباين بثوبٍ جديد: نسخة (الفرع) خدمت المستخدمين لبرهة، ثم استبدلها بصمت
...
- وثائق **CodePush / App Center** من Microsoft للتحديث عبر الأثير — التراجع، والتحديث الإلزامي، وكيف يكتب إصدار لاحق فوق الحزمة الحالية.
...
فخّ الإصدار المتباين من الدرسين 6.1 و6.2 يظهر هنا في أحدّ صوره. تخيّل علَمًا واحدًا اسمه
`new_checkout` يعني في تطبيق اليوم *«وجِّه إلى صفحة الدفع المعاد تصميمها»* — لكنه قبل ثلاثة
أشهر، في إصدارٍ ما زال يشغّله آلاف المستخدمين، كان الاسم نفسه يعني *«أظهِر شارة النسخة
التجريبية»*. اقلبه لتفعيل التصميم الجديد، فيُضيء كل أولئك المتخلّفين شارةً لشاشةٍ لم تعد
موجودة. العلَم نفسه، تأويلان، حيّان معًا — أحدهما على عميل اليوم، والآخر على إصدارٍ لا تصل
إليه. ولا يلزم أن يمتد الأمر عبر الإصدارات: مسارا كودٍ في تطبيقٍ واحد يقرآن العلَم بطريقتين
مختلفتين هما العلة نفسها. والدرس: **علَمٌ بأكثر من مؤوِّلٍ واحد سلاحٌ مُلقَّم.**
...
كاملة (هندسة الفوضى) حول *إثبات* أنها تعمل — لأن فشلًا لم تتمرّن عليه قط فشلٌ لا تنجو منه. (ودخلت Hystrix نفسها وضع الصيانة نحو عام 2018؛ و**resilience4j** هي البديل الحالي على منصة JVM. المهم هو *النمط* — ولكل لغة نمطها — لا المكتبة بعينها.)
