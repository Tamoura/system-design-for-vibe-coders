...
export const PAGES: Page[] = [
  { title: 'Monitors', keywords: 'dashboard checks uptime', path: (o) => `/${o}/monitors`, permission: 'monitor.read' },
  ...
  { title: 'Settings', keywords: 'organization status page public logo upload', path: (o) => `/${o}/settings`, permission: 'page.publish' },
  { title: 'Public status page', keywords: 'status page public', path: (o) => `/status/${o}` },
  { title: 'Account', keywords: 'profile password github sign out', path: () => '/account' },
