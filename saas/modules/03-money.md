...
| [Unleash/unleash](https://github.com/Unleash/unleash) | Feature flag platform, useful for keeping flags *separate* from entitlements | TypeScript, Node | Apache-2.0 | You need rollouts, and must not confuse them with plans |
