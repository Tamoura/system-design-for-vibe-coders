...
الأمان في SaaS شيئان يغذي كل منهما الآخر: **الهندسة** التي تحفظ بيانات المستأجرين، و**الأدلة** التي تثبت ذلك لأشخاص لا يستطيعون قراءة الكود. **في SaaS الموجه للشركات (B2B SaaS)، الأمان الذي لا تستطيع إثباته لا يُحسب، والإثبات الذي لا تسنده هندسة حقيقية لن يصمد بعد أول حادثة (incident).**
